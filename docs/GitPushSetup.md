...
- **우선순위 URL 목록**: `npm run list-priority-urls` — GSC URL 검사·Amplitude 확인용 URL 한 줄씩 출력 — https://funnyfunny.cloud 성능·접근성·권장사항·SEO 점검, `lighthouse-report.html` 생성 (gitignore됨).
