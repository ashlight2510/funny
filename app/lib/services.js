...
export function getAllServices(lang = "en") {
  ...
  return [
    ...
    { href: "https://funnyfunny.cloud/tools/calc-001/", icon: "🧮", title: isKo ? "단가 계산" : "단가 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/calc-002/", icon: "📐", title: isKo ? "비율 계산" : "비율 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/calc-003/", icon: "📊", title: isKo ? "평균 계산" : "평균 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/calc-004/", icon: "💰", title: isKo ? "할인 계산" : "할인 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/calc-005/", icon: "⏱️", title: isKo ? "시간 계산" : "시간 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/calc-006/", icon: "📏", title: isKo ? "면적 계산" : "면적 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/calc-007/", icon: "🔢", title: isKo ? "요약 계산" : "요약 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/calc-008/", icon: "📈", title: isKo ? "증가율 계산" : "증가율 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/calc-009/", icon: "🔄", title: isKo ? "변환 계산" : "변환 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/calc-010/", icon: "⚖️", title: isKo ? "비교 계산" : "비교 계산", desc: isKo ? "간단 계산." : "간단 계산.", tags: isKo ? ["calc"] : ["calc"] },
    { href: "https://funnyfunny.cloud/tools/test-001/", icon: "🧪", title: isKo ? "스트레스 체크" : "스트레스 체크", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-002/", icon: "📋", title: isKo ? "습관 진단" : "습관 진단", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-003/", icon: "💭", title: isKo ? "관계 유형" : "관계 유형", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-004/", icon: "🎯", title: isKo ? "커리어 성향" : "커리어 성향", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-005/", icon: "📊", title: isKo ? "금융 지식" : "금융 지식", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-006/", icon: "🔍", title: isKo ? "건강 점수" : "건강 점수", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-007/", icon: "💡", title: isKo ? "수면 품질" : "수면 품질", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-008/", icon: "❤️", title: isKo ? "식습관 체크" : "식습관 체크", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-009/", icon: "🧠", title: isKo ? "운동 습관" : "운동 습관", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-010/", icon: "⚖️", title: isKo ? "기분 진단" : "기분 진단", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-011/", icon: "🌱", title: isKo ? "자신감 테스트" : "자신감 테스트", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-012/", icon: "⏰", title: isKo ? "창의성 체크" : "창의성 체크", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-013/", icon: "😴", title: isKo ? "시간관리" : "시간관리", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-014/", icon: "🍽️", title: isKo ? "소통 스타일" : "소통 스타일", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-015/", icon: "🏃", title: isKo ? "번아웃 위험도" : "번아웃 위험도", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-016/", icon: "😊", title: isKo ? "일중독 체크" : "일중독 체크", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-017/", icon: "💪", title: isKo ? "우울감 체크" : "우울감 체크", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-018/", icon: "🌈", title: isKo ? "불안 수준" : "불안 수준", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-019/", icon: "📈", title: isKo ? "자존감 테스트" : "자존감 테스트", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-020/", icon: "🤝", title: isKo ? "감정조절" : "감정조절", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-021/", icon: "🧪", title: isKo ? "결단력 체크" : "결단력 체크", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-022/", icon: "📋", title: isKo ? "리더십 스타일" : "리더십 스타일", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-023/", icon: "💭", title: isKo ? "팀워크 성향" : "팀워크 성향", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-024/", icon: "🎯", title: isKo ? "갈등해결" : "갈등해결", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-025/", icon: "📊", title: isKo ? "재무 성향" : "재무 성향", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-026/", icon: "🔍", title: isKo ? "절약 지수" : "절약 지수", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-027/", icon: "💡", title: isKo ? "투자 성향" : "투자 성향", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-028/", icon: "❤️", title: isKo ? "생활만족도" : "생활만족도", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-029/", icon: "🧠", title: isKo ? "워라밸 체크" : "워라밸 체크", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-030/", icon: "⚖️", title: isKo ? "목표의식" : "목표의식", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-031/", icon: "🌱", title: isKo ? "학습 스타일" : "학습 스타일", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-032/", icon: "⏰", title: isKo ? "집중력 체크" : "집중력 체크", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-033/", icon: "😴", title: isKo ? "에너지 레벨" : "에너지 레벨", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-034/", icon: "🍽️", title: isKo ? "회복력 테스트" : "회복력 테스트", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-035/", icon: "🏃", title: isKo ? "감사 성향" : "감사 성향", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-036/", icon: "😊", title: isKo ? "낙관성 체크" : "낙관성 체크", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-037/", icon: "💪", title: isKo ? "호기심 수준" : "호기심 수준", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-038/", icon: "🌈", title: isKo ? "도전 성향" : "도전 성향", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-039/", icon: "📈", title: isKo ? "인내심 테스트" : "인내심 테스트", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/test-040/", icon: "🤝", title: isKo ? "집중력 학습" : "집중력 학습", desc: isKo ? "간단 체크." : "간단 체크.", tags: isKo ? ["test"] : ["test"] },
    { href: "https://funnyfunny.cloud/tools/util-001/", icon: "🛠️", title: isKo ? "오늘의 재테크 한줄" : "오늘의 재테크 한줄", desc: isKo ? "저축·소비·투자 인사이트 한 줄 뽑기." : "저축·소비·투자 인사이트 한 줄 뽑기.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-002/", icon: "💡", title: isKo ? "습관 인사이트" : "습관 인사이트", desc: isKo ? "습관·루틴 한 줄 뽑기." : "습관·루틴 한 줄 뽑기.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-003/", icon: "📌", title: isKo ? "생산성 한줄" : "생산성 한줄", desc: isKo ? "일·공부 생산성 팁 한 줄." : "일·공부 생산성 팁 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-004/", icon: "🔧", title: isKo ? "마음챙김 한줄" : "마음챙김 한줄", desc: isKo ? "마음챙김·명상 한 줄." : "마음챙김·명상 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-005/", icon: "📋", title: isKo ? "동기부여 한줄" : "동기부여 한줄", desc: isKo ? "동기부여·용기 한 줄 뽑기." : "동기부여·용기 한 줄 뽑기.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-006/", icon: "⚙️", title: isKo ? "시간관리 팁" : "시간관리 팁", desc: isKo ? "시간 쓰는 법 한 줄." : "시간 쓰는 법 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-007/", icon: "🎯", title: isKo ? "정리 인사이트" : "정리 인사이트", desc: isKo ? "정리·정돈 한 줄." : "정리·정돈 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-008/", icon: "📎", title: isKo ? "오늘의 다짐" : "오늘의 다짐", desc: isKo ? "오늘 하루 다짐 한 줄." : "오늘 하루 다짐 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-009/", icon: "✨", title: isKo ? "집중력 한줄" : "집중력 한줄", desc: isKo ? "집중·깊은 일 한 줄." : "집중·깊은 일 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-010/", icon: "🔍", title: isKo ? "휴식 한줄" : "휴식 한줄", desc: isKo ? "쉬는 법·회복 한 줄." : "쉬는 법·회복 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-011/", icon: "🛠️", title: isKo ? "관계 한줄" : "관계 한줄", desc: isKo ? "사람·소통 인사이트 한 줄." : "사람·소통 인사이트 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-012/", icon: "💡", title: isKo ? "자기계발 한줄" : "자기계발 한줄", desc: isKo ? "성장·배움 한 줄." : "성장·배움 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-013/", icon: "📌", title: isKo ? "목표 한줄" : "목표 한줄", desc: isKo ? "목표·다짐 한 줄." : "목표·다짐 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-014/", icon: "🔧", title: isKo ? "감사 한줄" : "감사 한줄", desc: isKo ? "감사·감사일기 한 줄." : "감사·감사일기 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-015/", icon: "📋", title: isKo ? "수면 한줄" : "수면 한줄", desc: isKo ? "잠·휴식 팁 한 줄." : "잠·휴식 팁 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-016/", icon: "⚙️", title: isKo ? "건강 한줄" : "건강 한줄", desc: isKo ? "건강·몸 인사이트 한 줄." : "건강·몸 인사이트 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-017/", icon: "🎯", title: isKo ? "스트레스 한줄" : "스트레스 한줄", desc: isKo ? "스트레스·풀기 한 줄." : "스트레스·풀기 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-018/", icon: "📎", title: isKo ? "결정 한줄" : "결정 한줄", desc: isKo ? "결정·선택 인사이트 한 줄." : "결정·선택 인사이트 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-019/", icon: "✨", title: isKo ? "창의성 한줄" : "창의성 한줄", desc: isKo ? "아이디어·창의 한 줄." : "아이디어·창의 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-020/", icon: "🔍", title: isKo ? "독서 한줄" : "독서 한줄", desc: isKo ? "책·읽기 인사이트 한 줄." : "책·읽기 인사이트 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-021/", icon: "🛠️", title: isKo ? "돈 마인드 한줄" : "돈 마인드 한줄", desc: isKo ? "돈·소비 마인드 한 줄." : "돈·소비 마인드 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-022/", icon: "💡", title: isKo ? "일과 삶 한줄" : "일과 삶 한줄", desc: isKo ? "워라밸·일 삶 균형 한 줄." : "워라밸·일 삶 균형 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-023/", icon: "📌", title: isKo ? "감정 한줄" : "감정 한줄", desc: isKo ? "감정·기분 인사이트 한 줄." : "감정·기분 인사이트 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-024/", icon: "🔧", title: isKo ? "용기 한줄" : "용기 한줄", desc: isKo ? "도전·용기 한 줄." : "도전·용기 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-025/", icon: "📋", title: isKo ? "소통 한줄" : "소통 한줄", desc: isKo ? "말하기·듣기 한 줄." : "말하기·듣기 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-026/", icon: "⚙️", title: isKo ? "미니멀 한줄" : "미니멀 한줄", desc: isKo ? "간소화·미니멀 한 줄." : "간소화·미니멀 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-027/", icon: "🎯", title: isKo ? "오늘의 질문" : "오늘의 질문", desc: isKo ? "하루를 돌아보는 질문 한 줄." : "하루를 돌아보는 질문 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-028/", icon: "📎", title: isKo ? "에너지 한줄" : "에너지 한줄", desc: isKo ? "에너지·활력 한 줄." : "에너지·활력 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-029/", icon: "✨", title: isKo ? "실패 한줄" : "실패 한줄", desc: isKo ? "실패·배움 한 줄." : "실패·배움 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-030/", icon: "🔍", title: isKo ? "현재 한줄" : "현재 한줄", desc: isKo ? "지금 여기·현재 한 줄." : "지금 여기·현재 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-031/", icon: "🛠️", title: isKo ? "칭찬 한줄" : "칭찬 한줄", desc: isKo ? "나·남 칭찬 한 줄." : "나·남 칭찬 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-032/", icon: "💡", title: isKo ? "변화 한줄" : "변화 한줄", desc: isKo ? "변화·새 시작 한 줄." : "변화·새 시작 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-033/", icon: "📌", title: isKo ? "경계 한줄" : "경계 한줄", desc: isKo ? "경계·선 그기 한 줄." : "경계·선 그기 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-034/", icon: "🔧", title: isKo ? "기다림 한줄" : "기다림 한줄", desc: isKo ? "인내·기다림 한 줄." : "인내·기다림 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-035/", icon: "📋", title: isKo ? "용서 한줄" : "용서 한줄", desc: isKo ? "용서·풀기 한 줄." : "용서·풀기 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-036/", icon: "⚙️", title: isKo ? "선택과 집중 한줄" : "선택과 집중 한줄", desc: isKo ? "우선순위·집중 한 줄." : "우선순위·집중 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-037/", icon: "🎯", title: isKo ? "일상 한줄" : "일상 한줄", desc: isKo ? "일상·루틴 한 줄." : "일상·루틴 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-038/", icon: "📎", title: isKo ? "기대 한줄" : "기대 한줄", desc: isKo ? "기대·희망 한 줄." : "기대·희망 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-039/", icon: "✨", title: isKo ? "혼자 시간 한줄" : "혼자 시간 한줄", desc: isKo ? "혼자·나만의 시간 한 줄." : "혼자·나만의 시간 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-040/", icon: "🔍", title: isKo ? "작은 성취 한줄" : "작은 성취 한줄", desc: isKo ? "성취·완료 한 줄." : "성취·완료 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-041/", icon: "🛠️", title: isKo ? "질문 한줄" : "질문 한줄", desc: isKo ? "스스로에게 묻는 질문 한 줄." : "스스로에게 묻는 질문 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-042/", icon: "💡", title: isKo ? "디지털 디톡스 한줄" : "디지털 디톡스 한줄", desc: isKo ? "스크린·디지털 한 줄." : "스크린·디지털 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-043/", icon: "📌", title: isKo ? "자연 한줄" : "자연 한줄", desc: isKo ? "자연·바깥 한 줄." : "자연·바깥 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-044/", icon: "🔧", title: isKo ? "유머 한줄" : "유머 한줄", desc: isKo ? "웃음·가벼움 한 줄." : "웃음·가벼움 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-045/", icon: "📋", title: isKo ? "나다움 한줄" : "나다움 한줄", desc: isKo ? "자기수용·나다움 한 줄." : "자기수용·나다움 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-046/", icon: "⚙️", title: isKo ? "연결 한줄" : "연결 한줄", desc: isKo ? "사람·연결 한 줄." : "사람·연결 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-047/", icon: "🎯", title: isKo ? "끝맺음 한줄" : "끝맺음 한줄", desc: isKo ? "마무리·마감 한 줄." : "마무리·마감 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-048/", icon: "📎", title: isKo ? "배움 한줄" : "배움 한줄", desc: isKo ? "배움·성장 한 줄." : "배움·성장 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-049/", icon: "✨", title: isKo ? "순간 한줄" : "순간 한줄", desc: isKo ? "지금 이 순간 한 줄." : "지금 이 순간 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/util-050/", icon: "🔍", title: isKo ? "용기와 두려움 한줄" : "용기와 두려움 한줄", desc: isKo ? "두려움·용기 한 줄." : "두려움·용기 한 줄.", tags: isKo ? ["util"] : ["util"] },
    { href: "https://funnyfunny.cloud/tools/game-001/", icon: "🎲", title: isKo ? "간식 추천 룰렛" : "간식 추천 룰렛", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-002/", icon: "🎯", title: isKo ? "영화 장르 추천" : "영화 장르 추천", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-003/", icon: "🍿", title: isKo ? "노래 추천 뽑기" : "노래 추천 뽑기", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-004/", icon: "🎵", title: isKo ? "책 테마 추천" : "책 테마 추천", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-005/", icon: "📖", title: isKo ? "취미 추천 뽑기" : "취미 추천 뽑기", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-006/", icon: "🎮", title: isKo ? "주말 룰렛" : "주말 룰렛", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-007/", icon: "✈️", title: isKo ? "여행지 추천 뽑기" : "여행지 추천 뽑기", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-008/", icon: "🍹", title: isKo ? "음료 추천 룰렛" : "음료 추천 룰렛", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-009/", icon: "🍰", title: isKo ? "디저트 추천 룰렛" : "디저트 추천 룰렛", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-010/", icon: "⚽", title: isKo ? "운동 추천 뽑기" : "운동 추천 뽑기", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-011/", icon: "🎬", title: isKo ? "드라마 추천" : "드라마 추천", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-012/", icon: "🛍️", title: isKo ? "쇼핑 카테고리 추천" : "쇼핑 카테고리 추천", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-013/", icon: "🎲", title: isKo ? "점심 메뉴 추천" : "점심 메뉴 추천", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-014/", icon: "🎯", title: isKo ? "저녁 메뉴 추천" : "저녁 메뉴 추천", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-015/", icon: "🍿", title: isKo ? "카페 메뉴 추천" : "카페 메뉴 추천", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-016/", icon: "🎵", title: isKo ? "과일 추천 뽑기" : "과일 추천 뽑기", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-017/", icon: "📖", title: isKo ? "색상 뽑기" : "색상 뽑기", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-018/", icon: "🎮", title: isKo ? "숫자 뽑기" : "숫자 뽑기", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-019/", icon: "✈️", title: isKo ? "요일 뽑기" : "요일 뽑기", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    { href: "https://funnyfunny.cloud/tools/game-020/", icon: "🍹", title: isKo ? "계절 뽑기" : "계절 뽑기", desc: isKo ? "랜덤 뽑기." : "랜덤 뽑기.", tags: isKo ? ["game"] : ["game"] },
    {
...
const CALCULATOR_SLUGS = [
  ...
  "calc-001", "calc-002", "calc-003", "calc-004", "calc-005", "calc-006", "calc-007", "calc-008", "calc-009", "calc-010", "coin-flip", "rps", "random-name", "random-number", "team-split", "spin-wheel", "card-draw", "bingo-caller", "truth-dare", "yes-no",
  ...
  "game-001", "game-002", "game-003", "game-004", "game-005", "game-006", "game-007", "game-008", "game-009", "game-010", "game-011", "game-012", "game-013", "game-014", "game-015", "game-016", "game-017", "game-018", "game-019", "game-020",
];
