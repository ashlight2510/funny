...
export const pageCopy = {
  ko: {
    ...
    langEnglish: "English",
    heroBadgeMain: "무료",
    heroBadgeSub: "회원가입 없이",
    heroTitle: "계산기·테스트·유틸리티 한곳에",
    heroSubtitle:
      "세금, D-day, 자산 체크, 심리테스트부터 오늘의 한 줄까지. 필요한 걸 빠르게 쓰세요.",
    heroServiceCount: "총 {count}개 서비스",
    heroCtaCalculators: "계산기 모음",
    heroCtaTests: "테스트 모음",
    heroCtaGuides: "가이드",
    featuredTitle: "인기·시즌 추천",
    featuredSubtitle: "지금 많이 쓰는 도구",
    categoryCalculators: "계산기",
    categoryTests: "테스트",
    categoryUtils: "유틸·인사이트",
    categoryGames: "게임",
  ...
  en: {
    ...
    langEnglish: "English",
    heroBadgeMain: "Free",
    heroBadgeSub: "No sign-up",
    heroTitle: "Calculators, tests & utilities in one place",
    heroSubtitle:
      "Tax, D-day, asset check, psychology tests, and daily one-liners. Use what you need, fast.",
    heroServiceCount: "{count} services in total",
    heroCtaCalculators: "Calculators",
    heroCtaTests: "Tests",
    heroCtaGuides: "Guides",
    featuredTitle: "Popular & seasonal",
    featuredSubtitle: "Most used right now",
    categoryCalculators: "Calculators",
    categoryTests: "Tests",
    categoryUtils: "Utils & insights",
    categoryGames: "Games",
    ...
    popularGuidesLabel: "Popular guides",
