export const guides = [
    ...
    faq: [
      {
        ...
        answer:
          "아니요. 실제 심사가 아닌 밈/패러디 톤의 재미용 결과입니다.",
      },
      {
  ...
  },
  {
    ...
    keywords: ["꿈일기", "꿈 기록", "드림 다이어리", "localStorage", "로컬 저장"],
    sections: [
      {
        heading: "꿈일기 한눈에 보기",
        body: [
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "네, 동일한 링크로 여러 사람이 들어와 플레이할 수 있습니다.",
      },
    ],
    disclaimer:
...
const guideSeeds = [
  ...
  },
  {
    ...
    note:
      "추천은 참고용이며 개인 취향에 따라 다를 수 있습니다. 여러 무드를 비교해 오늘의 컨디션에 맞는 것을 골라보세요.",
  },
  {
    ...
    note:
      "참고용 정보이며 피부 진단/치료가 아닙니다. 피부 트러블이나 질환이 지속되면 전문가 상담을 권장합니다.",
    disclaimer:
