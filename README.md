...
3. 🧴 화장품 루틴 딸깍 체크 (`cosmetics.funnyfunny.cloud`)
4. ⚡ 내 삶의 에너지 배분 테스트 (`energy.funnyfunny.cloud`)
5. 🛡️ 내 자산 방탄 지수 테스트 (`money.funnyfunny.cloud`)
6. 💸 비트코인 안 산 죄 계산기 (`bit.funnyfunny.cloud`)
7. 2️⃣ 대한민국 평균 vs 나 (`average.funnyfunny.cloud`)
8. 🏠 집값 못 산 죄 계산기 (`house.funnyfunny.cloud`)
9. ⏰ 인생 남은 시간 대시보드 (`life.funnyfunny.cloud`)
10. 🎓 우리 집 사교육 지옥도 계산기 (`edu.funnyfunny.cloud`)
11. 🩺 건강수명 예측 & 노후 준비 대시보드 (`health.funnyfunny.cloud`)
12. 🤣 오늘의 아재개그 (`joke.funnyfunny.cloud`)
13. 🧠 오늘의 마음챙김 (`mind.funnyfunny.cloud`)
14. 🧠 하루 정신 체력 지수 테스트 (`mental.funnyfunny.cloud`)
15. ☕ 카페 지출 총자산 역전 계산기 (`cafe.funnyfunny.cloud`)
16. 🥁 드럼 비트 연습기 (`beat.funnyfunny.cloud`)
17. 🎵 지금 이 시간에 어울리는 음악 (`music.funnyfunny.cloud`)
18. 📅 SenseYear (준비중) (`senseyear.funnyfunny.cloud`)
19. 🎨 EmojiCon Studio (`emojicon.site`) — 이모지 아이콘 스튜디오
20. 🍺 그때 마신 술, 지금 얼마? (`drink.funnyfunny.cloud`)
21. 🍱 오늘 뭐 먹지? (`cook.funnyfunny.cloud`)
22. 🔮 SoulPrint (`soul.funnyfunny.cloud`) — 출생 정보를 바탕으로 한 독자적인 성향 분석
23. 🛕 하루 한 문장 (`temple.funnyfunny.cloud`) — 불교 가르침을 오늘의 언어로 풀어낸 하루 한 문장
24. 😴 잠들기 도우미 (`sleep.funnyfunny.cloud`) — 코골이·주변 소음 위로 덮는 백색소음 & 환경음
